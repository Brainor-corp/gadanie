            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        ...
                        4.Что он будет чувствовать к вам в будущем (через 6-12 месяцев), если ничего не случится и вектор развития ваших отношений не изменится. <br>
                        5.Чем все закончится. Стоит ли развивать отношения и что из этого получится? <br>
                    </span>
                </div>
