...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-na-vernost-lyubimogo.css">
...
<div class="divination na-vernost-lyubimogo" data-card-count="10" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Эмоциональное состояние загаданного человека на текущий период времени. <br>
                        2.Тайные мысли Вашего партнера, касательно Вас и Ваших с ним отношений.<br>
                        3.Состояние Вашего партнера, которое он пытается демонстрировать.<br>
                        4.Мысли, цели и ожидания загаданного человека от Ваших с ним отношений.<br>
                        5.Отношение Вашего партнера к Вашей интимной жизни.<br>
                        6.Какие именно отношения нужны Вашему партнеру, какой человек ему подходит. Данная карта показывает те чувства Вашей второй половины, о которых он или она может даже не догадываться.<br>
                        7.Осознанные мысли и чувства загаданного человека.<br>
                        8.Что чувствует и испытывает к Вам Ваш партнер на самом деле.<br>
                        9.Факт измены.<br>
                        10.Что Вас ждет в будущем с загаданным человеком.<br>
                    </span>
                </div>
