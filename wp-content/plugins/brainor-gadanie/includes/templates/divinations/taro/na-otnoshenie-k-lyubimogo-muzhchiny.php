...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-na-otnoshenie-k-lyubimogo-muzhchiny.css">
...
<div class="divination na-otnoshenie-k-lyubimogo-muzhchiny" data-card-count="3" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Общее впечатление, которое вы производите на загаданного человека, то есть его сознательная оценка вашей личности и поступков. <br>
                        2.Это чувства, которые испытывает к вам любимый человек. <br>
                        3.Подсознательное отношение к вам любимого человека. <br>
                    </span>
                </div>
