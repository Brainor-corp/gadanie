...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-podxodite-li-vy-drug-drugu.css">
...
<div class="divination podxodite-li-vy-drug-drugu" data-card-count="6" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Ваши общие черты и схожести со второй половиной. <br>
                        2.Уязвимые места и основные расхождения во взглядах с Вашим партнером.<br>
                        3.Общая картина Вашей интимной жизни. Карта указывает на то, что устраивает и чего не хватает партнерам на интимном уровне.<br>
                        4.Насколько комфортно Вам и Вашему партнеру в повседневной жизни и быту.<br>
                        5.Характеристика того, что именно подразумеваете Вы и Ваш партнер под таким понятием, как «Семья».<br>
                        6.Наличие или отсутствие перспектив на развитие отношений в ближайшем будущем.<br>
                    </span>
                </div>
