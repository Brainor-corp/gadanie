...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-na-zavtrashnij-den.css">
...
<div class="divination na-zavtrashnij-den" data-card-count="6" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Ваши собственные мысли по истечению суток со дня гадания. <br>
                        2.То, что Вы будете чувствовать уже завтра.<br>
                        3.Ваше завтрашнее эмоциональное состояние.<br>
                        4.Те события, которые ожидают Вас завтра.<br>
                        5.Наиболее выгодные и беспроигрышные дела, которыми стоит непременно заняться завтра.<br>
                        6.Общий вывод, взятый из трактовок карт под № 4 и №5. Данная карта расскажет Вам о результате грядущих событий и Ваших поступках в тех или иных ситуациях.<br>
                    </span>
                </div>
