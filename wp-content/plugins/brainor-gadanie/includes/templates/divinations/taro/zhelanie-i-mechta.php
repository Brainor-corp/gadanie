...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-zhelanie-i-mechta.css">
...
<div class="divination zhelanie-i-mechta" data-card-count="5" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Ваша мечта. <br>
                        2.Содействующая или препятствующая сила в исполнении мечты. <br>
                        3.Что нужно предпринять для воплощения своей мечты. <br>
                        4.Исход - осуществится ли мечта. <br>
                        5.Карта-совет. <br>
                    </span>
                </div>
