...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-na-situaciyu.css">
...
<div class="divination na-situaciyu" data-card-count="8" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Нынешнее состояние дел. <br>
                        2.Что еще только начинается..<br>
                        3.Отдаленное будущее.<br>
                        4.Ваши надежды.<br>
                        5.Ваши страхи.<br>
                        6.С какой стороны можно ожидать помощь.<br>
                        7.Какие помехи могут возникнуть на вашем пути.<br>
                        8.Указывает как на развязку этой ситуации, так и на начало следующей, с ней связанной.<br>
                    </span>
                </div>
