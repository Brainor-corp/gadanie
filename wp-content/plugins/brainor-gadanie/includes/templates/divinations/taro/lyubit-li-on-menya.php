...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-lyubit-li-on-menya.css">
...
<div class="divination lyubit-li-on-menya" data-card-count="5" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Его интерес к вам. Что он ценит в вас. <br>
                        2.Его мысли о вас. <br>
                        3.Что он сейчас чувствует к вам (любит - не любит). <br>
                        4.Что он будет чувствовать к вам в будущем (через 6-12 месяцев), если ничего не случиться и вектор развития ваших отношений не измениться. <br>
                        5.Чем все закончиться. Стоит ли развивать отношения и что из этого получится? <br>
                    </span>
                </div>
