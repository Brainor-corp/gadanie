...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-na-dengi.css">
...
<div class="divination na-dengi" data-card-count="6" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Финансовая ситуация в настоящее время. Что вы имеете на сегодняшний день. <br>
                        2.Почему возникли материальные затруднения? Причина. <br>
                        3.Что поможет исправить финансовую ситуацию? <br>
                        4.Что необходимо, чтобы улучшить материальное положение? Личные качества, действия, поступки. <br>
                        5.Какие действия нужно предпринять для улучшения благосостояния? <br>
                        6.Каким будет финансовое положение в ближайшие три месяца? <br>
                    </span>
                </div>
