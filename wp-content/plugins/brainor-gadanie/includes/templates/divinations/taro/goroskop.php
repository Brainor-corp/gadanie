...
<link rel="stylesheet" href="/wp-content/plugins/brainor-gadanie/assets/css/divination-taro-goroskop.css">
...
<div class="divination goroskop" data-card-count="12" id="<?php echo uniqid() ?>">
    <div class="taro_bg">
        <div class="hand">
        ...
        <div class="desk">
            <div class="desk-left">
                ...
                <div class="desk-cards">
                    ...
                    <div class="desk-card" id="desk-card-12">
                        <small>12</small>
                        <br>
            ...
            <div class="desk-right">
                <div class="hidden-card card-0" id="hidden-card-0">
                    <span class="text-white">
                        1.Овен. Твоя личность, твой внутренний мир. <br>
                        2.Телец. Бизнес, деньги, финансы.<br>
                        3.Близнецы. Общество, друзья, отношения.<br>
                        4.Рак. Дом и семья.<br>
                        5.Лев. Любовь и отношения.<br>
                        6.Дева. Работа, ситуация на работе а так же здоровье.<br>
                        7.Весы. Социальное жизнь. Развлечения, общение.<br>
                        8.Скорпион. Изменения и перемены в социальной сфере.<br>
                        9.Стрелец. Учеба, познание, философия жизни, а так же путешествия.<br>
                        10.Козерог. Потенциал, профессия и репутация.<br>
                        11.Водолей. Проекты и цели.<br>
                        12.Рыбы. Трудности, препятствия и помехи.<br>
                    </span>
                </div>
